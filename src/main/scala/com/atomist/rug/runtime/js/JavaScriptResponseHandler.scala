...
class JavaScriptResponseHandlerFinder(
  ...
  extends BaseJavaScriptHandlerFinder[JavaScriptResponseHandler](ctx) {
  /**
    *
  ...
  override protected def extractHandler(jsc: JavaScriptContext, handler: ScriptObjectMirror, ctx: JavaScriptHandlerContext): Option[JavaScriptResponseHandler] = {
