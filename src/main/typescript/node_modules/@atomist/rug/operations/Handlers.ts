...
interface EventHandler<R extends TreeNode, M extends TreeNode> extends Handler {
  expression: PathExpression<R,M> | string
  handle(root: Match<R,M>): Plan | Message
}

interface ResponseHandler<T> extends Handler{
...
type Plannable = Edit | Generate | Review | Execute | Command
...
export {Respond, Instruction, ResponseHandler, CommandHandler, EventHandler, Response, CommandContext, Plan, Message}
