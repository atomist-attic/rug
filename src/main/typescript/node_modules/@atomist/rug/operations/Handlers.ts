...
interface HandleCommand {
  handle(ctx: HandlerContext): CommandPlan | Plan
}

interface HandleEvent<R extends GraphNode, M extends GraphNode> {
  handle(root: Match<R, M>): EventPlan | Plan
}
...
type EventPlanMessage = LifecycleMessage | DirectedMessage

type CommandMessage = ResponseMessage
...
export class EventPlan extends Plan {
  ...
  public add?(msg: EventPlanMessage): this {
    return super.add(msg);
  }

  static ofMessage(m: EventPlanMessage): EventPlan {
...
export class CommandPlan extends Plan {
  ...
  public add?(msg: CommandMessage): this {
    return super.add(msg);
  }
