import {Respond, Instruction, Response, CommandContext, Plan, Message} from './Handlers'
import {TreeNode, Match, PathExpression} from '../tree/PathExpression'
import {EventHandler, ResponseHandler, CommandHandler, Parameter, Tags, Intent} from './Decorators'
import {Project} from '../model/Core'
import {HandleResponse, HandleEvent, HandleCommand} from './Handlers'
...
@EventHandler("ClosedIssueReopener","Reopens closed issues", new ClosedIssues())
@Tags("github", "issues")
