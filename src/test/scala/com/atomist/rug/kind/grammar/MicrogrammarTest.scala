...
import com.atomist.model.content.grammar.microgrammar._
import com.atomist.model.content.grammar.{AbstractMatchListener, MatchListener, PositionalString}
import com.atomist.model.content.text._
import org.scalatest.{FlatSpec, Matchers}

class MicrogrammarTest extends FlatSpec with Matchers {
  ...
  it should "parse and update complete match" in {
    val g4 =
      """
        ...
        |expr: thing=THING;
      """.stripMargin
    val g = new InMemAntlrMicrogrammar(g4, "expr")
  ...
  private def aWasaB: Microgrammar = {
    val g4 =
      """
        |NAME: [A-Z][a-z]+;
        |AGE: [0-9]+;
      ...
      """.stripMargin
    new InMemAntlrMicrogrammar(g4, "expr")
  }
  ...
  private def matchScalaMethodHeaderRepsep: Microgrammar = {
    val g4 =
      """
      ...
      """.stripMargin
    new InMemAntlrMicrogrammar(g4, "method")
  }
  ...
  private def matchAnnotatedJavaFields: Microgrammar = {
    val g4 =
      """
        | IDENTIFIER : [a-zA-Z0-9]+;
        | visibility: ('public')| ('private');
        | annotation: '@' IDENTIFIER;
        | field : annotation visibility type=IDENTIFIER name=IDENTIFIER;
      """.stripMargin
    new InMemAntlrMicrogrammar(g4, "field")
  }
  ...
  private def matchPrivateJavaFields: Microgrammar = {
    val g4 =
      """
        | IDENTIFIER : [a-zA-Z0-9]+;
        | field : 'private' type=IDENTIFIER name=IDENTIFIER ';';
      """.stripMargin
    new InMemAntlrMicrogrammar(g4, "field")
  }
  ...
  private def ymlKeys: Microgrammar = {
    val g4 =
      """
        | KEY: [A-Za-z_]+;
        | VALUE: [A-Za-z0-9\-]+;
      ...
      """.stripMargin
    new InMemAntlrMicrogrammar(g4, "env_list")
  }
