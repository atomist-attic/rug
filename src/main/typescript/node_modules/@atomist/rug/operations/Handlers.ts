...
interface CommandRunner{
  ...
  run(ctx: CommandContext): Plan | Message
}
...
interface ResponseHandler<T> {
  respond(response: Response<T>): Plan | Message
}
...
export {Respond, Instruction, ResponseHandler, CommandRunner, Secret, EventHandler, Response, CommandContext, Plan, Message, PathExpression}
