...
export function Given(s: string, f: (Project, any?) => void) { _definitions.Given(s, f) }

export function When(s: string, f: (Project, any?) => void) { _definitions.When(s, f) }

export function Then(s: string, f: (Project, any?) => Result | boolean) { _definitions.Then(s, f) }
